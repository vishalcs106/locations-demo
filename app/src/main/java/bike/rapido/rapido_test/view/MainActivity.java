...
import bike.rapido.rapido_test.Constants;
import bike.rapido.rapido_test.PlaceJSONParser;
import bike.rapido.rapido_test.R;
import bike.rapido.rapido_test.RetrofitHelper;
import bike.rapido.rapido_test.model.ApiService;
import bike.rapido.rapido_test.model.Ride;
import bike.rapido.rapido_test.model.Route;
import bike.rapido.rapido_test.presenter.LocationPresenter;
import bike.rapido.rapido_test.presenter.PlacePresenter;
import bike.rapido.rapido_test.presenter.RoutesPresenter;
...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Retrofit retrofit = RetrofitHelper.newInstance();
    ...
    @Override
    public Observable<JsonObject> getPlaces(String url) {
